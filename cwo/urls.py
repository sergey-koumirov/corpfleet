...
urlpatterns = [
    ...
    url(r'^(?P<war_id>[0-9]+)/participant/(?P<participant_id>[0-9]+)/update', views.update_participant, name='update_participant'),
    ...
    url(r'^(?P<war_id>[0-9]+)/territory/(?P<territory_id>[0-9]+)/update', views.update_territory, name='update_territory'),
